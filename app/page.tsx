  ...
  return (
    <main className="bg-[#F5F7FA] min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-8">
        <div className="grid grid-cols-3 gap-0 bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="text-center py-6 px-4">
            <p className="text-2xl md:text-3xl font-black text-[#003087]">{books.length}권</p>
            <p className="text-xs text-gray-400 mt-1">이번 달 구조 도서</p>
          </div>
          <div className="text-center py-6 px-4 border-x border-gray-200">
            <p className="text-2xl md:text-3xl font-black text-gray-800">12,311</p>
            <p className="text-xs text-gray-400 mt-1">누적 조회 수</p>
          </div>
          <div className="text-center py-6 px-4">
            <p className="text-2xl md:text-3xl font-black text-emerald-600">+41%</p>
            <p className="text-xs text-gray-400 mt-1">평균 대출 증가율</p>
          </div>
        </div>
      </div>
      ...
      {/* 푸터 */}
      <footer className="border-t border-gray-200 bg-white pt-10 pb-8 px-6 md:px-16 text-gray-400 text-xs">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-8 mb-8">
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className="text-gray-800 font-black text-base tracking-tight">BOOK RESCUE</span>
                <span className="px-2 py-0.5 bg-[#003087] text-white text-[10px] font-semibold rounded">공모전 출품작</span>
              </div>
            ...
            <div className="flex flex-col gap-2">
              <p className="text-gray-600 font-semibold mb-1 text-xs">데이터 출처</p>
              <a href="https://www.data4library.kr/" target="_blank" rel="noreferrer" className="hover:text-[#003087] transition-colors">정보나루 (도서관 빅데이터)</a>
              <a href="https://www.nl.go.kr/" target="_blank" rel="noreferrer" className="hover:text-[#003087] transition-colors">국립중앙도서관</a>
            </div>
          </div>
